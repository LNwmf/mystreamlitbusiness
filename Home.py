...
st.title("About Us")
st.write("Welcome! This app is created by Lisly from the World Music Foundation to provide exposure to new music in fun ways. Each page includes a series of questions that returns a playlist that you can share. There's also a guessing and trivia game to test your musical knowledge!")
